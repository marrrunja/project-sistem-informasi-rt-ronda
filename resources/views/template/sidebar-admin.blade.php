            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/admin/manage" aria-expanded="false">
                        ...
                        <span class="hide-menu">Manage Warga</span>
                    </a>
                </li>
                <!-- <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/admin/jadwal" aria-expanded="false">
                        ...
                        <span class="hide-menu">Jadwal Ronda</span>
                    </a>
                </li>
                <!-- <li class="sidebar-item">
            ...
            <!-- <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
                <div class="d-flex">
                    ...
                    <div class="unlimited-access-img">
                        ...
                        <img src="{{ asset('resources/assets/images/backgrounds/rocket.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div> -->
        </nav>
