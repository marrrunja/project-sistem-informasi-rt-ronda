                                ...
                                <div class="">
                                    <div class="card py-2 bg-active">
                                        <div class="d-flex flex-column justify-content-center align-items-center">
                                            <h4>{{{ \Carbon\Carbon::parse($jadwal->jadwal_masuk)->translatedFormat('j') }}}</h4>
                                            <div>
                                                {{ \Carbon\Carbon::parse($jadwal->jadwal_masuk)->translatedFormat('F') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><span class="badge text-bg-{{ $absen->status === 1 ? 'secondary':'warning' }}">
                                            {{ $absen->status === 1 ? 'Hadir': 'Tidak hadir' }}
                                        </span></td>
                                    </tr>
                                    @endforeach
                                    @else
                                    <tr>
                                        <td colspan="3" class="text-center">
                                            Belum ada warga yang terdaftar di jadwal ini
                                        </td>
                                    </tr>
                                    @endif
